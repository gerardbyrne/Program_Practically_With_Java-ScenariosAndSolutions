package labten.exercisefour;

import java.util.Scanner;

public class AgentClaimIteration
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            {
                System.out.printf("Claim %d made by agent %s relates to policy %s. %nThe claim amount is $%.2f, which is %.2f plus %.2f taxes and the claim description is%n ===> %s. %nThe status of the claim is ** not complete ** and processing of the claim will continue.%n", claimId, agentId, policyId, claimAmount, claimAmountBeforeTax, taxAmount, claimDescription);
            }
...
} // End of AgentClaimIteration class