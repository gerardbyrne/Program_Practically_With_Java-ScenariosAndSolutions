package labfour.exercisethree;

import java.util.Scanner;

public class EmployeePaySelection
{
    ...
    public static void main(String[] args)
    {
        ...
        if(hoursWorked < 45)
        {
            System.out.printf("%s has worked %.2f hours with a base pay rate of $%.2f giving them a pay amount of $%.2f", employeeName, hoursWorked, basePayRate, payAmount);
        }// End of if statement

    } // End of main() method
} // End of EmployeePaySelection class