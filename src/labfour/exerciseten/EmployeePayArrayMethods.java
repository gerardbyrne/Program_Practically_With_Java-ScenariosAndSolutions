...
// public void addEmployeeToArrayOfArrays(int counter, String employeeName, double hoursWorked, double payAmount)
    public void addEmployeeToArrayOfArrays(int counter, Employee myEmployee)
    {
        switch(counter)
        {
            case 0:
                employeesArray[0][0] = myEmployee.employeeName;
                employeesArray[0][1] = String.valueOf(myEmployee.hoursWorked);
                if (myEmployee.hoursWorked > 45)
                {
                    employeesArray[0][2] = "HR";
                } else
                {
                    employeesArray[0][2] = String.valueOf(myEmployee.payAmount);
                }
                break;
            case 1:
                employeesArray[1][0] = myEmployee.employeeName;
                employeesArray[1][1] = String.valueOf(myEmployee.hoursWorked);
                if (myEmployee.hoursWorked > 45)
                {
                    employeesArray[1][2] = "HR";
                } else
                {
                    employeesArray[1][2] = String.valueOf(myEmployee.payAmount);
                }
                break;
            case 2:
                employeesArray[2][0] = myEmployee.employeeName;
                employeesArray[2][1] = String.valueOf(myEmployee.hoursWorked);
                if (myEmployee.hoursWorked > 45)
                {
                    employeesArray[2][2] = "HR";
                } else
                {
                    employeesArray[2][2] = String.valueOf(myEmployee.payAmount);
                }
                break;
