...
{
    public void writeInvoiceItemsToTextFile(String invoiceItems[], String filePathToBeWrittenTo)
    {
        System.out.println("***********************************************");
        System.out.println(" Writing invoice item details to the text file ");
        System.out.println("***********************************************");
        ...
        try
        {
          ...
          */
          ...
          /*
           ...
           array ClaimNumbers to the file
          */
            for(int counter = 0; counter<invoiceItems.length; counter++)
            {
                    bufferedWriter.write(invoiceItems[counter]);
    ...
    } // End of writeInvoiceItemsToTextFile() method

    public void readInvoiceItemsFromTextFile(String filePathToBeReadFrom)
    {
        System.out.println("***************************************");
    ...
    } // End of readInvoiceItemsFromTextFile() method
