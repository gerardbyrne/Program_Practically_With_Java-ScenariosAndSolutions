...
import labfive.exerciseten.Claim;
...
public class ClaimDataMethods
{
    ...
    int totalNumberOfClaims, totalNumberOfClaimsFromArrayOfArrays;
    double averageNumberOfClaims, averageNumberOfClaimsFromArrayOfArrays;
    int ClaimNumbers[] = new int[12];
    String ClaimMonth[] = {"January", "February", "March", "April", "May", "June",
                                  "July", "August", "September", "October", "November","December"};
    String claimData2DArray[][] = new String[12][2];

    public void acceptClaimDetails()
    {
        ...
        for(int counter = 0; counter < 12; counter ++)
        {
            ...
            // Instantiate the ClaimMonthlyNumbers class and pass it the month and number of claims made
            ClaimMonthlyNumbers myClaimMonthlyNumbers = new ClaimMonthlyNumbers(claimData2DArray[counter][0], Integer.parseInt(claimData2DArray[counter][1]));

            // Call the serialise method
            mySerialiseDeserialise.serialiseTheClaimMonthlyNumbersObject(myClaimMonthlyNumbers);

            // Call the deserialise method
            mySerialiseDeserialise.deSerialiseTheClaimMonthlyNumbersObject();

            // Display the current ClaimMonthlyNumbers details for reference only
            System.out.println(myClaimMonthlyNumbers.toString());
        }
    }  // End of acceptClaimDetails() method

    public void calculateTotalNumberOfClaims(int[] ClaimNumbers)
    {
    ...
    public void calculateAverageOfClaims()
    {
    ...
    public void calculateMonthlyVariances()
    {
    ...
    public void calculateTotalNumberOfClaimsFromArrayOfArrays(String ClaimNumbers[][])
    {
        // Iterate the array and accumulate the total
    ...
    public void calculateAverageOfClaimsFromArrayOfArrays()
    {
        // Calculate the average number of
        // claims per month
    ...
    public void calculateMonthlyVariancesFromArrayOfArrays()
    {
        // Iterate the array and calculate the monthly variance between the
        // actual number of claims and the average monthly claims
        for(int counter =0 ; counter < 12; counter++)
    ...
    public void displayClaimDetailsFromArrayOfArrays()
    {
        // Display the contents of the array of arrays
        for (int outerCounter = 0; outerCounter < 12; outerCounter++)
        {
    ...
    public void calculateMaximumNumberOfClaimsFromArrayOfArrays()
    {
    ...
    public void calculateMinimumNumberOfClaimsFromArrayOfArrays()
    {
    ...
    public void displayGraphOfClaimsNumbers()
    {
