...
public class USStatesMethods
{
    ...
    public void addItemsToArray(String[] stateDetails, int arrayPositionCounter)
    {
       ...
       SerialiseDeserialise mySerialiseDeserialise = new SerialiseDeserialise();
        ...
        State myState = new State(stateDetails[arrayPositionCounter], stateDetails[arrayPositionCounter + 1], Integer.parseInt(stateDetails[arrayPositionCounter + 2]));

        // Call the serialise method passing it the State item
        mySerialiseDeserialise.serialiseTheStateObject(myState);
        ...
        mySerialiseDeserialise.deSerialiseTheStateObject();
