...
public class ClaimsArrayMethods
{
    ...
    public void storeValuesInArrayOfArrays(int counter, Claim myClaim)
    {
        // Add claim values and calculated values to the array of arrays at the correct position
        ClaimDetails2D[counter][0] = myClaim.claimOneAmount;
        ClaimDetails2D[counter][1] = myClaim.claimTwoAmount;
        ClaimDetails2D[counter][2] = myClaim.totalOfClaims;
        ClaimDetails2D[counter][3] = myClaim.averageOfClaims;
