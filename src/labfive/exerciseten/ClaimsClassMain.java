...
public class ClaimsClassMain
{
    ...
    {
        // Create instances of the four classes that have been created
        ...
        for (int counter =0; counter < 3; counter++)
        {
            ...
            // Create an instance of the Claim class and pass the four variables to the constructor
            Claim myClaim   = new Claim(myClaimsInputAndDisplayMethods.claimOneAmount, myClaimsInputAndDisplayMethods.claimTwoAmount, totalOfClaims, averageOfClaims);
            ...
            // Add the class to the array of arrays
            myClaimsArrayMethods.storeValuesInArrayOfArrays(counter, myClaim);

            // Display the current Claim details for reference only
